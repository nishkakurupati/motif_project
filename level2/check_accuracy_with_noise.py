import motif_benchmark_with_noise
import parameters
...
def check_acc():
    ...
    for k in range (10):
        for i in range (len(parameters.params_list)):
            ...
            motif_match = motif_benchmark_with_noise.compare_motif(ml,sc,sl,k)
            
            full_site_match, site_matches = motif_benchmark_with_noise.compare_sites(ml,sc,sl,k)
